                ...
                <div class="card-body">
                   <form action="{{route('transaksi.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" name="waktu_pembayaran" class="form-control @error('waktu_pembayaran') is-invalid @enderror">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jumlah_bayar"  placeholder="Rp." class="form-control @error('jumlah_bayar') is-invalid @enderror">
                             @error('jumlah_bayar')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
